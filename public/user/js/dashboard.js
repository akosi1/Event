...
function showCertificateInfo(eventId) {
    // Get event data from the info button's data attributes
    const showCertificateBtn = document.querySelector(`button[onclick="showCertificateInfo(${eventId})"]`);
    ...
    // Get and sanitize all data attributes
    const certificatePath = showCertificateBtn.getAttribute('data-certificate-path');
    const eventTitle = showCertificateBtn.getAttribute('data-event-title') || 'Event Title Unavailable';
    const generatedDate = showCertificateBtn.getAttribute('data-certificate-date') || 'N/A';

    // Set modal title
    document.getElementById('modalTitle').textContent = showCertificateBtn.getAttribute('data-event-title') || 'Event';
        ...
        <div class="certificate-card">
            <div class="certificate-image-container">
                <img src="${certificatePath}"
                    alt="Certificate for ${eventTitle}"
                    class="certificate-image"
                    onerror="this.onerror=null; this.src='/images/default-event.jpg';">
            </div>

            <div class="certificate-content">
                <h3 class="certificate-event-title">${eventTitle}</h3>
                <p class="certificate-date">Generated on: ${generatedDate}</p>

                <a href="${certificatePath}" download class="download-btn">
    ...
    document.getElementById('modalTitle').textContent = 'Certificate Details';
    document.getElementById('eventInfoContent').innerHTML = modalContent;
