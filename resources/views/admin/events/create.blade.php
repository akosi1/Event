            ...
            <div class="card-body">
                <form action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data" id="eventForm">
                    ...
                    <div class="mb-4">
                        ...
                        <!-- Preview -->
                        <div id="certificateImagePreview" class="mt-3" style="display: none;">
                            <div class="border rounded p-3 bg-light">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <span class="text-success fw-semibold"><i class="fas fa-check-circle me-1"></i>Image Preview</span>
                                    <button type="button" class="btn btn-sm btn-outline-danger" onclick="removeTemplatePreview()">
                                        <i class="fas fa-times me-1"></i>Remove
                                    </button>
                                </div>
                                <img id="certificatePreviewImg" src="" alt="Preview" class="img-fluid rounded shadow-sm" style="max-height: 200px;">
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const ceertificateImageInput = document.getElementById('certificateTemplateImage');
    ...
    ceertificateImageInput.addEventListener('change', function(e) {
        const file = e.target.files[0];
        if (file) {
            const reader = new FileReader();
            reader.onload = function(e) {
...
function removeTemplatePreview() {
    document.getElementById('certificateTemplateImage').value = '';
