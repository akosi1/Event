        ...
        <div class="footer-content">
            <div class="footer-grid">
                <div class="footer-section">
                    ...
                    <p>Your premier platform for discovering and managing university events. Stay connected with your
                        campus community.</p>
            ...
            <div class="footer-bottom">
                <p>&copy; {{ date('Y') }} MCC E&PO. All rights reserved. | Designed with <i class="fas fa-heart"
                        style="color: #ef4444;"></i> for students</p>
            </div>
        </div>
    </footer>
