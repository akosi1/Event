    ...
    <style>
        * {
        ...
        .auth-container {
            ...
            text-align: center; /* Ensures header/buttons stay centered */
        }
        ...
        .form-select option {
            padding: 10px 16px !important; /* 🎯 FIX: Remove extra space in dropdown */
            margin: 0 !important;
        ...
        .form-select option:hover {
            background-color: rgba(107, 44, 145, 0.1) !important;
        }
